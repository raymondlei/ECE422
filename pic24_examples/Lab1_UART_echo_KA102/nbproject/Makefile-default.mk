...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/Lab1_UART_echo_KA102.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/Lab1_UART_echo_KA102.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
dist/${CND_CONF}/${IMAGE_TYPE}/Lab1_UART_echo_KA102.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	...
	${MP_CC_DIR}\\xc16-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/Lab1_UART_echo_KA102.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} -a  -omf=elf  
